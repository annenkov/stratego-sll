...
public class SLLParseControllerGenerated extends DynamicParseController 
{ 
  public static final String LANGUAGE = new String("SLL");
  ...
  { 
    SLLParseControllerGenerated.descriptor = descriptor;
  }
  ...
  { 
    try
    { 
      InputStream descriptorStream = SLLParseControllerGenerated.class.getResourceAsStream(DESCRIPTOR);
      InputStream table = SLLParseControllerGenerated.class.getResourceAsStream(TABLE);
      ...
      descriptor.setAttachmentProvider(SLLParseControllerGenerated.class);
    }
  ...
  { 
    return SLLParseController.class.getProtectionDomain().getCodeSource().getLocation().getFile();
  }
